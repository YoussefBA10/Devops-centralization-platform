...
% ============================================================================
\chapter{Context, Analysis and Proposed Solution}

\section*{Introduction}
\addcontentsline{toc}{section}{Introduction}
This chapter presents the company context, the identified operational gaps, the proposed architectural response, and the methodology adopted.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.2\textwidth]{"C4Context.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"GLOBALARCHITECTURE.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{"MonitoringProcessDiagram.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"ApplicationManagementRelationship.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{"Diagram_de_gantt.png"}
...
This chapter has established the company context, analyzed the limitations of the existing systems, and detailed the proposed five-phase architecture. Furthermore, the selection of technologies and the project planning details show a rigorous foundation that guides the development process. These architectural definitions and choices transition directly into Chapter 2, which details the realized implementation.

\newpage

% ============================================================================
% CHAPTER 2: REALIZED WORK
% ============================================================================
\chapter{Realized Work}

\section*{Introduction}
\addcontentsline{toc}{section}{Introduction}
This chapter presents the step-by-step implementation of the platform across two main parts. Part I covers the core backend foundation, database designs, and observability setups, while Part II details the advanced UI visualizations, Groq AI diagnostics, and security pipeline hardening integrations.

\section*{Part I — Core Infrastructure \& Backend Foundations}
\addcontentsline{toc}{section}{Part I — Core Infrastructure \& Backend Foundations}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"DatabaseSchemaDiagram.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{"LoginPageScreenshot.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"JWTAuthSequenceDiagram.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"RBACAnnotationCode.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"RBACUserEnvironments.png"}
...
The full API reference, including all endpoints added in subsequent phases, is provided in Section~\ref{app:api_reference}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"SwaggerAPIOverview.png"}
  \caption{REST API Overview: Phase 1 Endpoint Summary}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"FrontendProjectStructure.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"FrontendRoutingGuardFlow.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"DashboardLayout.png"}
...
\section*{Part II — Advanced Features \& DevSecOps Integration}
\addcontentsline{toc}{section}{Part II — Advanced Features \& DevSecOps Integration}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"AutomatedDeploymentSequence.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"ElasticsearchLogSearchPage.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"LogExportFlowDiagram.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth]{"RootCauseSignalPipeline.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"AIChatAssistantInterface.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{"LogDriftAnalysisPlot.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{"StabilityScoringFlow.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"JenkinsPipelineStages.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"PortainerContainerManagement.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{"CICDPipeline.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"SecurityDashboardOverview.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{"VaultSecretsInjectionWorkflow.png"}
  \caption{HashiCorp Vault Secrets Injection Workflow}
  \label{fig:vault_secrets}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"FalcoKernelMonitoringFlow.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{"BackendClassDiagram.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{"RBAC_Multi_Tenancy_Diagram_2.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{"Ticket_Lifecycle_State_Diagram_2.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{"InfrastructureTopologyEntity_2.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"RBACPermissionTable.png"}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{"CorrelationWindowTuning.png"}
...
\section{Future Roadmap: Beyond Phase 5}

With Phase 5 complete, the platform's architectural roadmap targets three future evolution steps:
\begin{enumerate}
...
\section*{Conclusion}
\addcontentsline{toc}{section}{Conclusion}
In conclusion, the realized work demonstrates a robust, end-to-end integration of monitoring, automation, and AI. The platform successfully bridges the gap between disconnected observability tools and automates key DevOps processes to deliver a highly reliable, multi-tenant environment.
...
\section{Deployment Architecture Diagrams}\label{app:deployment_diagrams}

\subsection{High-Level Infrastructure Deployment}
